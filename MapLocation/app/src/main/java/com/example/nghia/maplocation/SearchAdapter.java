...
public class SearchAdapter extends BaseAdapter {
    private /*Context thành tên màn hình*/ SearchActivity context;
    private int layout;
    private List<User> userList;

    public SearchAdapter(SearchActivity context, int layout, List<User> userList) {
    ...
    private void AddFriend (final String email, String name){
        ...
        dialogDelete.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                context.ReadJSONRequestFriend(email);
            }
        });
